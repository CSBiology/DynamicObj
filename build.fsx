...
module ProjectInfo = 
    ...
    let gitName = "DynamicObj"

    let website = "/DynamicObj"

    let pkgDir = "pkg"

    let release = ReleaseNotes.load "RELEASE_NOTES.md"

    let projectRepo = "https://github.com/CSBiology/DynamicObj"
